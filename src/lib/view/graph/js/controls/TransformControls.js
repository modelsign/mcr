...
( function () {
	...
	THREE.TransformGizmo = function () {
		...
		this.init = function () {
			...
			//// HANDLES AND PICKERS  初始化handles以及pickers，将handleGizmos里的object设置位置，并将其作为handles的child
	...
	THREE.TransformGizmoScale = function () {
		...
		mesh.position.y = 0.5;
		mesh.updateMatrix();  //更新local 的transformation
	...
	THREE.TransformControls = function ( camera, domElement ) {
      ...
      // var gizmoObj2 = _gizmo[ 'rotate' ];
      // gizmoObj2.visible = true;
      // this.add(gizmoObj2 );
		}
