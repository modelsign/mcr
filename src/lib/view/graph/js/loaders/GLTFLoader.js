...
THREE.GLTFLoader = (
    function () {
      ...
      GLTFLoader.prototype = {
        ...
        parse         : function (data, path, onLoad, onError) {
          ...
          if (json.extensionsUsed) {
            ...
            if (json.extensionsUsed.indexOf(EXTENSIONS.KHR_MATERIALS_COMMON)
                >= 0) {
              extensions[EXTENSIONS.KHR_MATERIALS_COMMON] = new GLTFMaterialsCommonExtension(
                  json);
            }
            if (json.extensionsUsed.indexOf(
                    EXTENSIONS.KHR_MATERIALS_PBR_SPECULAR_GLOSSINESS) >= 0) {
      ...
      function GLTFLightsExtension (json) {
        ...
        var extension = (
                            json.extensions
                            && json.extensions[EXTENSIONS.KHR_LIGHTS]
                        ) || {};
      ...
      GLTFMaterialsCommonExtension.prototype.extendParams    = function (
        ...
        switch (khrMaterial.type) {
          ...
          case 'commonPhong' :
            keys.push(
                'diffuseFactor', 'diffuseTexture', 'specularFactor',
                'specularTexture', 'shininessFactor'
            );
            break;
          case 'commonLambert' :
        ...
        if (materialValues.specularTexture !== undefined) {
          pending.push(parser.assignTexture(materialParams, 'specularMap',
      ...
      function GLTFMaterialsPbrSpecularGlossinessExtension () {
        return {
          ...
          extendParams            : function (params, material, parser) {
            ...
            params.glossiness = pbrSpecularGlossiness.glossinessFactor
                                !== undefined
            ...
            if (pbrSpecularGlossiness.specularGlossinessTexture !== undefined) {
              ...
              pending.push(parser.assignTexture(params, 'glossinessMap',
                                                specGlossIndex
              ));
              pending.push(
           ...
           * ShaderMaterial.copy() method can copy only properties it knows
           * about or inherits, and misses many properties that would normally
           * be defined by MeshStandardMaterial.
           *
           * This method allows GLTFSpecularGlossinessMaterials to be cloned in
           * the process of loading a glTF model, but cloning later (e.g. by
           * the user) would require these changes AND also updating
           * `.onBeforeRender` on the parent mesh.
           *
          ...
          // Here's based on refreshUniformsCommon() and
          // refreshUniformsStandard() in WebGLRenderer.
              ...
              if (uvScaleMap.matrix !== undefined) {
                ...
                if (uvScaleMap.matrixAutoUpdate === true) {
                  ...
                  uvScaleMap.matrix.setUvTransform(
                      offset.x, offset.y, repeat.x, repeat.y, rotation,
                      center.x, center.y
                  );
                }
      ...
      GLTFParser.prototype._withDependencies = function (dependencies) {
        ...
        for (var i = 0 ; i < dependencies.length ; i++) {
          ...
          var fnName     = 'load' + dependency.charAt(0).toUpperCase()
                           + dependency.slice(1);
      ...
      GLTFParser.prototype.loadAccessors = function () {
        ...
        return _each(json.accessors, function (accessor) {
          return parser.getDependency('bufferView', accessor.bufferView).then(
              function (bufferView) {
                ...
                if (byteStride && byteStride !== itemBytes) {
                  ...
                  // bytes.
                  var ib = new THREE.InterleavedBuffer(array, byteStride
                                                              / elementBytes);
      ...
      GLTFParser.prototype.assignTexture = function (
          materialParams, textureName, textureIndex) {
          ...
          return _each(json.animations, function (animation, animationId) {
            ...
            for (var i = 0 ; i < animation.channels.length ; i++) {
              ...
              if (sampler) {
                ...
                var input          = animation.parameters !== undefined
                    ? animation.parameters[sampler.input]
                    : sampler.input;
                var output         = animation.parameters !== undefined
          ...
          return _each(json.nodes, function (nodeDef) {
            ...
            return _each(__nodes, function (node, nodeIndex) {
              ...
              if (nodeDef.skin !== undefined) {
                var skinnedMeshes = [];
                var meshes        = node.children.length > 0
                    ? node.children
                    : [node];
