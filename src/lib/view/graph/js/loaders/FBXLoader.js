...
(
    function () {
      ...
      Object.assign(THREE.FBXLoader.prototype, {
        ...
        parse: function (FBXBuffer, resourceDirectory) {
          ...
          var textures    = parseTextures(
              FBXTree, new THREE.TextureLoader(this.manager).setPath(
          ...
          var sceneGraph  = parseScene(
              FBXTree, connections, skeletons, geometryMap, materials);
      ...
      // objects (e.g. material -> texture, model->geometry ) and details the
      // connection type
      ...
      function parseImage (videoNode) {
        ...
        switch (extension) {
          ...
          default:
            ...
            console.warn('FBXLoader: Image type "' + extension
                         + '" is not supported.');
            return;
      ...
      // These contain details such as UV scaling, cropping, rotation etc and
      // are connected to images in FBXTree.Objects.Video
        ...
        if ('Texture' in FBXTree.Objects) {
          ...
          for (var nodeID in textureNodes) {
            ...
            var texture = parseTexture(
                textureNodes[nodeID], loader, images, connections);
      ...
      function loadTexture (textureNode, loader, images, connections) {
        ...
        if (children !== undefined && children.length > 0
          ...
          if (fileName.indexOf('blob:') === 0 || fileName.indexOf('data:')
                                                 === 0) {
        ...
        if ('Material' in FBXTree.Objects) {
          ...
          for (var nodeID in materialNodes) {
            ...
            var material = parseMaterial(
                FBXTree, materialNodes[nodeID], textureMap, connections);
      ...
      function parseMaterial (FBXTree, materialNode, textureMap, connections) {
        ...
        var parameters = parseParameters(
            FBXTree, materialNode, textureMap, ID, connections);
      ...
      // Parse FBX material and return parameters suitable for a three.js
      // material Also parse the texture map and return any textures associated
      // with the material
      function parseParameters (
          FBXTree, properties, textureMap, ID, connections) {
          ...
          switch (type) {
            ...
            case 'DiffuseColor':
              parameters.map = getTexture(
                  FBXTree, textureMap, child.ID, connections);
              break;
      ...
      function getTexture (FBXTree, textureMap, id, connections) {
        ...
        // issue a warning
        if ('LayeredTexture' in FBXTree.Objects && id
                                                   in FBXTree.Objects.LayeredTexture) {
      ...
      // however only skinning is supported here Generates map of Skeleton-like
      // objects for use later when generating and binding skeletons.
      ...
      // The top level deformer nodes have type 'Skin' and subDeformer nodes
      // have type 'Cluster' Each skin node represents a skeleton and each
      // cluster node represents a bone
        ...
        connections.children.forEach(function (child) {
          ...
          var rawBone = {
            ...
            transform    : new THREE.Matrix4().fromArray(
                subDeformerNode.Transform.a),
            transformLink: new THREE.Matrix4().fromArray(
                subDeformerNode.TransformLink.a),
        ...
        if ('Geometry' in FBXTree.Objects) {
          ...
          for (var nodeID in geometryNodes) {
            ...
            var geo           = parseGeometry(
                FBXTree, relationships, geometryNodes[nodeID], skeletons);
        ...
        switch (geometryNode.attrType) {
          ...
          case 'Mesh':
            return parseMeshGeometry(
                FBXTree, relationships, geometryNode, skeletons);
            break;
      ...
      function parseMeshGeometry (
        ...
        var skeleton = relationships.children.reduce(
        ...
        // AND the models have different geometric transforms, then this will
        // cause problems if ( modelNodes.length > 1 ) { }
        ...
        if ('GeometricRotation' in modelNode) {
          ...
          preTransform.makeRotationFromEuler(
              new THREE.Euler().fromArray(array));
        ...
        return genGeometry(
            FBXTree, relationships, geometryNode, skeleton, preTransform);
      ...
      function genGeometry (
        ...
        vertexIndices.forEach(function (vertexIndex, polygonVertexIndex) {
          ...
          // -4, 6, 0, 2, -5 } Negative numbers mark the end of a face - first
          // face here is 0, 1, 3, -3 to find index of last vertex multiply by
          // -1 and subtract 1: -3 * - 1 - 1 = 2
          if (vertexIndex < 0) {
            
            vertexIndex = vertexIndex ^ -1; // equivalent to
                                            // ( x * -1 ) - 1
          ...
          vertexPositionIndexes.push(vertexIndex * 3, vertexIndex * 3
                                                      + 1, vertexIndex * 3 + 2);
          
          if (colorInfo) {
            
            var data = getData(
                polygonVertexIndex, polygonIndex, vertexIndex, colorInfo);
          ...
          if (normalInfo) {
            ...
            var data = getData(
                polygonVertexIndex, polygonIndex, vertexIndex, normalInfo);
          ...
          if (materialInfo && materialInfo.mappingType !== 'AllSame') {
            ...
            var materialIndex = getData(
                polygonVertexIndex, polygonIndex, vertexIndex, materialInfo)[0];
          ...
          if (uvInfo) {
            ...
            uvInfo.forEach(function (uv, i) {
              ...
              var data = getData(
                  polygonVertexIndex, polygonIndex, vertexIndex, uv);
          ...
          if (endOfFace) {
            ...
            for (var i = 2 ; i < faceLength ; i++) {
              ...
              vertexBuffer.push(vertexPositions[vertexPositionIndexes[(
                                                                          i - 1
                                                                      ) * 3]]);
              vertexBuffer.push(vertexPositions[vertexPositionIndexes[(
                                                                          i - 1
              ...
              if (skeleton) {
                ...
                vertexWeightsBuffer.push(faceWeights[(
                                                         i - 1
                                                     ) * 4]);
                vertexWeightsBuffer.push(faceWeights[(
                                                         i - 1
        ...
        if (colorsBuffer.length > 0) {
          ...
          geo.addAttribute(
              'color', new THREE.Float32BufferAttribute(colorsBuffer, 3));
        ...
        uvsBuffer.forEach(function (uvBuffer, i) {
          ...
          geo.addAttribute(
              name, new THREE.Float32BufferAttribute(uvsBuffer[i], 2));
        ...
        if (materialInfo && materialInfo.mappingType !== 'AllSame') {
          ...
          if (geo.groups.length > 0) {
            ...
            if (lastIndex !== materialIndexBuffer.length) {
              ...
              geo.addGroup(
                  lastIndex, materialIndexBuffer.length - lastIndex,
                  prevMaterialIndex
              );
      ...
      // Parse Vertex Colors from FBXTree.Objects.Geometry.LayerElementColor if
      // it exists
      ...
      function getMaterials (MaterialNode) {
        ...
        // between FBX and what we expect.So we create an intermediate buffer
        // that points to the index in the buffer, for conforming with the
        // other functions we've written for other data.
        var materialIndices = [];
      ...
      // Functions use the infoObject and given indices to return value array
      // of
      // geometry. Parameters: - polygonVertexIndex - Index of vertex in draw
      // order (which index of the index buffer refers to this vertex). -
      // polygonIndex - Index of polygon in geometry. - vertexIndex - Index of
      // vertex inside vertex buffer (used because some data refers to old
      // index buffer that we don't use anymore). - infoObject: can be
      // materialInfo, normalInfo, UVInfo or colorInfo Index type: - Direct:
      // index is same as polygonVertexIndex - IndexToDirect: infoObject has
      ...
      var GetData = {
        ...
        ByVertice: {
          ...
          Direct: function (
            ...
            var from = (
                vertexIndex * infoObject.dataSize
            );
            var to   = (
                           vertexIndex * infoObject.dataSize
                       ) + infoObject.dataSize;
      ...
      function parseNurbsGeometry (geometryNode) {
        ...
        if (isNaN(order)) {
          ...
          console.error(
              ...
              geometryNode.Order, geometryNode.id
          );
          return new THREE.BufferGeometry();
        ...
        var curve    = new THREE.NURBSCurve(
            degree, knots, controlPoints, startKnot, endKnot);
      ...
      function parseScene (
          FBXTree, connections, skeletons, geometryMap, materialMap) {
        
        var sceneGraph = new THREE.Group();
        
        var modelMap = parseModels(
            FBXTree, skeletons, geometryMap, materialMap, connections);
        ...
        modelMap.forEach(function (model) {
          ...
          setLookAtProperties(
              FBXTree, model, modelNode, connections, sceneGraph);
      ...
      function parseModels (
        ...
        for (var nodeID in modelNodes) {
          ...
          var model = buildSkeleton(
              relationships, skeletons, id, node.attrName);
          ...
          if (!model) {
            ...
            switch (node.attrType) {
              ...
              case 'Mesh':
                model = createMesh(
                    FBXTree, relationships, geometryMap, materialMap);
                break;
              case 'NurbsCurve':
                model = createCurve(relationships, geometryMap);
                break;
              case 'LimbNode': // usually associated with a Bone, however if a
                               // Bone was not created we'll make a Group
                               // instead
              case 'Null':
              default:
          ...
          for (var ID in skeletons) {
            ...
            skeleton.rawBones.forEach(function (rawBone, i) {
              ...
              if (rawBone.ID === parent.ID) {
                ...
                // set name and id here - otherwise in cases where "subBone" is
                // created it will not have a name / id
                ...
                // duplicate the bone here and and it as a child of the first
                // bone
                if (subBone !== null) {
      ...
      function createLight (FBXTree, relationships) {
        ...
        if (lightAttribute === undefined) {
          ...
          var intensity = (
                          ...
                          ) ? 1 : lightAttribute.Intensity.value / 100;
          ...
          // TODO: could this be calculated linearly from FarAttenuationStart to
          // FarAttenuationEnd?
          var decay = 1;
      ...
      function createCurve (relationships, geometryMap) {
        ...
        var material = new THREE.LineBasicMaterial(
            { color: 0x3300ff, linewidth: 1 });
        return new THREE.Line(geometry, material);
        
      }
      
      // Parse ambient color in FBXTree.GlobalSettings - if it's not set to
      // black (default), create an ambient light
      function createAmbientLight (FBXTree, sceneGraph) {
        
        if ('GlobalSettings' in FBXTree && 'AmbientColor'
                                           in FBXTree.GlobalSettings) {
      ...
      function setModelTransforms (FBXTree, model, modelNode) {
        ...
        if ('RotationOrder' in modelNode) {
          ...
          if (value > 0 && value < 6) {
            ...
            // Note: Euler order other than XYZ is currently not supported, so
            // just display a warning for now
            console.warn(
      ...
      function bindSkeleton (
          FBXTree, skeletons, geometryMap, modelMap, connections) {
      ...
      function parseAnimations (FBXTree, connections) {
        ...
        // FBXTree.Objects.AnimationCurve, if this is undefined we can safely
        // assume there are no animations
        ...
        var layersMap = parseAnimationLayers(
            FBXTree, connections, curveNodesMap);
      ...
      // each AnimationCurveNode holds data for an animation transform for a
      // model (e.g. left arm rotation ) and is referenced by an AnimationLayer
      ...
      // previously parsed AnimationCurveNodes. Each AnimationCurve holds data
      // for a single animated axis ( e.g. times and values of x rotation)
      ...
      // node note: theoretically a stack can multiple layers, however in
      // practice there always seems to be one per stack
          ...
          if (connection !== undefined) {
            ...
            children.forEach(function (child, i) {
              ...
              if (curveNodesMap.has(child.ID)) {
                ...
                // check that the curves are defined for at least one axis,
                // otherwise ignore the curveNode
                if (curveNode.curves.x !== undefined || curveNode.curves.y
                  ...
                  if (layerCurveNodes[i] === undefined) {
                    ...
                    connections.get(child.ID).parents.forEach(
                        function (parent) {
                    ...
                    // if the animated model is pre rotated, we'll have to apply
                    // the pre rotations to every animation value as well
                    if ('PreRotation'
                        in rawModel) {
      ...
      // node in the animation hierarchy. Each Stack node will be used to
      // create a THREE.AnimationClip
      function parseAnimStacks (FBXTree, connections, layersMap) {
        ...
        for (var nodeID in rawStacks) {
          ...
          if (children.length > 1) {
            ...
            // layer. But just in case there are files where there are multiple
            // layers per stack, we'll display a warning
            console.warn(
      ...
      function generateTracks (rawTracks) {
        ...
        if (rawTracks.T !== undefined && Object.keys(rawTracks.T.curves).length
                                         > 0) {
          
          var positionTrack = generateVectorTrack(
              rawTracks.modelName, rawTracks.T.curves,
        ...
        if (rawTracks.R !== undefined && Object.keys(rawTracks.R.curves).length
                                         > 0) {
          
          var rotationTrack = generateRotationTrack(
              rawTracks.modelName, rawTracks.R.curves,
        ...
        if (rawTracks.S !== undefined && Object.keys(rawTracks.S.curves).length
                                         > 0) {
          
          var scaleTrack = generateVectorTrack(
              rawTracks.modelName, rawTracks.S.curves, rawTracks.initialScale,
              'scale'
          );
      ...
      function generateVectorTrack (modelName, curves, initialValue, type) {
        ...
        return new THREE.VectorKeyframeTrack(
            modelName + '.' + type, times, values);
        
      }
      
      function generateRotationTrack (
          modelName, curves, initialValue, preRotations) {
        ...
        for (var i = 0 ; i < values.length ; i += 3) {
          ...
          quaternion.toArray(quaternionValues, (
                                                   i / 3
                                               ) * 4);
      ...
      Object.assign(TextParser.prototype, {
        ...
        parse: function (text) {
          ...
          split.forEach(function (line, i) {
            ...
            var matchBeginning = line.match('^\\t{' + self.currentIndent
                                            + '}(\\w+):(.*){', '');
            ...
            if (matchBeginning) {
              ...
              // large arrays are split over multiple lines terminated with a
              // ',' character if this is encountered the line needs to be
        ...
        parseNodeProperty: function (line, property, contentLine) {
          ...
          var propName  = property[1].replace(/^"/, '')
                                     .replace(/"$/, '')
                                     .trim();
          var propValue = property[2].replace(/^"/, '')
                                     .replace(/"$/, '')
                                     .trim();
        ...
        parseNodePropertyContinued: function (line) {
          ...
          // property value so convert the string to an array
          if (line.slice(-1) !== ',') {
      ...
      Object.assign(BinaryParser.prototype, {
        ...
        parseNode: function (reader, version) {
          ...
          var endOffset     = (
                                  version >= 7500
                              ) ? reader.getUint64() : reader.getUint32();
          var numProperties = (
                                  version >= 7500
                              ) ? reader.getUint64() : reader.getUint32();
          ...
          // [0, 1, 2]}
          node.singleProperty = (
                                    numProperties === 1 && reader.getOffset()
                                                           === endOffset
                                ) ? true : false;
        ...
        parseSubNode: function (name, node, subNode) {
          ...
          if (subNode.singleProperty === true) {
            ...
            subNode.propertyList.forEach(function (property, i) {
              ...
              // first Connection is FBX type (OO, OP, etc.). We'll discard
              // these
              if (i !== 0) {
                array.push(property);
              }
            ...
            if (innerPropName.indexOf('Lcl ')
                === 0) {
              innerPropName = innerPropName.replace('Lcl ', 'Lcl_');
            }
            if (innerPropType1.indexOf('Lcl ')
                === 0) {
          ...
          switch (type) {
            ...
            case 'l':
              ...
              var inflate = new Zlib.Inflate(
                  new Uint8Array(reader.getArrayBuffer(compressedLength))); // eslint-disable-line
                                                                            // no-undef
      ...
      Object.assign(BinaryReader.prototype, {
        ...
        // value is out of the range between Number.MAX_SAFE_INTEGER and
        // Number.MIN_SAFE_INTEGER. TODO: safely handle 64-bit integer
        getInt64: function () {
      ...
      // TextParser ( FBX ASCII format) and BinaryParser( FBX Binary format)
      function FBXTree () {}
      ...
      function isFbxFormatBinary (buffer) {
        ...
        return buffer.byteLength >= CORRECT.length && CORRECT
               === convertArrayBufferToString(buffer, 0, CORRECT.length);
